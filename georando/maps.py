...
OFFICIAL_MAPS: List[GeoGuessrMap] = [
    ...
    official_map("Chile", difficulty=3, provides=["South America"]),
    ...
    official_map("Japan", difficulty=4, provides=["Asia"]),
    ...
    official_map("Peru", difficulty=5, provides=["South America"]),
    ...
    official_map("Russia", difficulty=5),
    ...
    official_map("Spain"),
    official_map("Sri Lanka", difficulty=6, provides=["Asia"]),
    ...
    official_map("Ukraine", difficulty=6, provides=["Europe"]),
    official_map(
    ...
    official_map("Uruguay", difficulty=6, provides=["South America"]),
